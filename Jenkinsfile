...
DOCKER_IMAGE_CAST = "fastapicast"
DOCKER_IMAGE_MOVIE = "fastapimovie"
            ...
            stage(' Build Cast Image') {
                steps {
                    script {
                        ...
                        docker build -t $DOCKER_ID/$DOCKER_IMAGE_CAST:$DOCKER_TAG ./Jenkins_devops_exams/cast-service
                        sleep 6
                        '''
                    }
                }
            ...
            stage(' Build Movie Image') {
                steps {
                    script {
                        ...
                        docker build -t $DOCKER_ID/$DOCKER_IMAGE_MOVIE:$DOCKER_TAG ./Jenkins_devops_exams/movie-service
                        sleep 6
                        '''
                    }
                }
